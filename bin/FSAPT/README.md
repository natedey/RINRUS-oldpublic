...
Example usage:
	...
	input: python3 ~/git/RINRUS_master/bin/FSAPT/sapt2rins.py -p FG-SAPT.dat -c contact_counts.dat -s A:293,A:294
...
FSAPT-based ranking.
	...
	python3 ~/git/RINRUS/bin/rinrus_trim2_pdb.py -s A:293,A:294 -pdb template_27.pdb -c res_atoms-fsapt.dat
